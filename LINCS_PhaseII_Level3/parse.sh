...
#Will Create
parallelFile=$createdFilesFolder/LINCS_PhaseII_Level3_parallel.txt
metaDataOutFilePrefix=$metaDataOutFiles/LINCS_PhaseII_Level3_inst_id_group_metadata_
expressionDataOutFilePrefix=$expressionDataOutFiles/LINCS_PhaseII_Level3_inst_id_group_expression_data_
