...
#for f in data_clinical_sample.txt data_clinical_patient.txt data_CNA.txt data_mutations_extended.txt data_expression.txt
for f in data_clinical_patient.txt
do
