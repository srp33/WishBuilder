...
<center>Feb 28, 18. 09:02 MST</center>
...
|	---	|	---	|	---	|
|	TCGA-02-0047-01A-01R-1849-01	|	Cancer_Type	|	Glioblastoma multiforme	|
|	TCGA-02-0047-01A-01R-1849-01	|	form_completion_date	|	2008-12-16	|
|	TCGA-02-0047-01A-01R-1849-01	|	gender	|	MALE	|
|	TCGA-02-0047-01A-01R-1849-01	|	race	|	WHITE	|

**Columns: 3 Rows: 584808**
...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "days_to_laboratory_procedure_tumor_marker_squamous" for all samples is the same ("[Not Available]"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "pathologic_stage" for all samples is the same ("[Not Available]"). This variable has been removed from metadata.tsv.gz</p>
...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "type_of_analysis_other" for all samples is the same ("[Not Available]"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "site_of_primary_tumor_other" for all samples is the same ("[Not Available]"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "tumor_tissue_site_other" for all samples is the same ("[Not Applicable]|[Not Applicable]"). This variable has been removed from metadata.tsv.gz</p>
...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "other_metastatic_involvement_anatomic_site" for all samples is the same ("Lymph node"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "chemo_concurrent_reason_not_other" for all samples is the same ("Concurent chemo RT Ongoing-treatment delayed due t"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "radiation_type_other" for all samples is the same ("Whole pelvis split field"). This variable has been removed from metadata.tsv.gz</p>
