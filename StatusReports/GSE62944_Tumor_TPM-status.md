...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "chemo_concurrent_reason_not_other" for all samples is the same ("Concurent chemo RT Ongoing-treatment delayed due to postoperative complications."). This variable has been removed from metadata.tsv.gz</p>
