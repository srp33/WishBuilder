...
<center>Mar 19, 18 12:03PM MST</center>
...
||	Sample	|	Column	|	Row	|
|	---	|	---	|	---	|	---	|
|	**Expected**	|	HT55	|	ARF5	|	i179.484972	|
...
&#10060;	 Sample "UMRC6_KIDNEY" is in "data.tsv.gz" but not in "metadata.tsv.gz"

&#10060;	 Sample "HS870T_BONE" is in "data.tsv.gz" but not in "metadata.tsv.gz"

&#10060;	 Sample "TC32_BONE" is in "data.tsv.gz" but not in "metadata.tsv.gz"

&#10060;	 Sample "TIG3TD_LUNG" is in "data.tsv.gz" but not in "metadata.tsv.gz"

&#10060;	 Sample "MOLT3_MOLT4" is in "data.tsv.gz" but not in "metadata.tsv.gz"

&#10060;	 Sample "HS172T_URINARY_TRACT" is in "data.tsv.gz" but not in "metadata.tsv.gz"
