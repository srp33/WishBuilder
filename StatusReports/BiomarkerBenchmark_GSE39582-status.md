...
&#10060;	All values for variable "braf.mutation.protein" are the same("p.V600E").

&#10060;	All values for variable "braf.mutation.exon.number" are the same("c.1799T>A").

&#10060;	All values for variable "braf.mutation.dna" are the same("c.1799T>A").
