...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "Treatment_Status" for all samples is the same ("pretreatment"). This variable has been removed from metadata.tsv.gz</p>
