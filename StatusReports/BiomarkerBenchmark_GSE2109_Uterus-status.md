...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "Presenting_Symptoms" for all samples is the same ("Vaginal bleeding"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "Grade" for all samples is the same ("3"). This variable has been removed from metadata.tsv.gz</p>
...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "Relapse_Since_Primary_Treatment" for all samples is the same ("No"). This variable has been removed from metadata.tsv.gz</p>
...
<p><font color="orange" size="+2">&#9888;	</font>The value for variable "Have_you_ever_been_diagnosed_as_having_HPV_on_your_PAP_smear" for all samples is the same ("No"). This variable has been removed from metadata.tsv.gz</p>

<p><font color="orange" size="+2">&#9888;	</font>The value for variable "Stage" for all samples is the same ("No AJCC Scheme for this site and histology"). This variable has been removed from metadata.tsv.gz</p>
